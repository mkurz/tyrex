...
CLASSPATH=${CLASSPATH}:${TOMCAT_HOME}/lib/j2ee/jndi.jar:${TOMCAT_HOME}/lib/j2ee/jdbc-se2.0.jar
CLASSPATH=${CLASSPATH}:${TOMCAT_HOME}/lib/j2ee/jta1.0.1.jar:${TOMCAT_HOME}/lib/j2ee/jts.jar
