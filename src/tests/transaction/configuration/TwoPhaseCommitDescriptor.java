 ...
 * XML Schema.
 * $Id: TwoPhaseCommitDescriptor.java,v 1.1 2001/02/16 23:47:55 mohammed Exp $
 */
...
**/
public class TwoPhaseCommitDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TwoPhaseCommitDescriptor() {
        super();
        xmlName = "two_phase_commit";
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                TwoPhaseCommit target = (TwoPhaseCommit) object;
    ...
    } //-- transaction.configuration.TwoPhaseCommitDescriptor()
    ...
    **/
    ...
    {
        return transaction.configuration.TwoPhaseCommit.class;
