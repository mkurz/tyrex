...
public class OnePhaseCommitDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OnePhaseCommitDescriptor() {
        super();
        xmlName = "one_phase_commit";
    ...
    } //-- transaction.configuration.OnePhaseCommitDescriptor()
    ...
    **/
    ...
    {
        return transaction.configuration.OnePhaseCommit.class;
